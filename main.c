...
int patientLogIn(const patientInfo *patients, int maxCount,
                 const char *inputUser, const char *pass);
void editPatientInfo(patientInfo *patient);
void takeAppointment(doctorInfo *doctors, patientInfo *patients);
void appointmentFinalization(doctorInfo doctors[MAX_DOCTORS],
                             patientInfo patients[MAX_PATIENTS]);
...
int docLogIn(const doctorInfo *doctors, int maxCount, const char *inputUser,
             const char *pass);
void docLogInPanel();
...
void savePatientsToFile(const patientInfo patients[MAX_PATIENTS],
                        const char *filename);
void loadPatientsFromFile(patientInfo patients[MAX_PATIENTS],
                          const char *filename);

void saveDoctorsToFile(const doctorInfo doctors[MAX_DOCTORS],
                       const char *filename);
...
void deleteAll(patientInfo patients[MAX_PATIENTS],
               doctorInfo doctors[MAX_DOCTORS], int *lastAssignedPatientID,
               int *lastAssignedDoctorID, int *lastAssignedWardID);

int searchWard(const medicalWard *wards, int maxCount, const char *patientName);
void addWard(medicalWard *wards, int *lastAssignedWardID,
             const char *patientName, const char *doctorName);
void deleteWard(medicalWard *wards, int *lastAssignedWardID,
                const char *patientName);
void displayWard(const medicalWard *wards, int maxCount);
void addPatientToWard(medicalWard *wards, int *lastAssignedWardID,
                      patientInfo *patients, int maxCountPatients,
                      doctorInfo *doctors, int maxCountDoctors);
void displayWardMenu();
void deletePatientFromWard(medicalWard *wards, int *lastAssignedWardID,
                           patientInfo *patients, int maxCountPatients);

void loadWardFromFile(medicalWard *wards, int *lastAssignedWardID,
                      const char *filename);
void saveWardToFile(const medicalWard *wards, int maxCount,
                    const char *filename);
int main() {
  ...
  while (1) {
    ...
    case 420:
      clear_terminal();
      deleteAll(patients, doctors, &lastAssignedPatientID,
                &lastAssignedDoctorID, &lastAssignedWardID);
      exit(0);
      break;
    case 3: {
      int wardChoice;
      while (1) {
        ...
        case 1:
          clear_terminal();
          addPatientToWard(wards, &lastAssignedWardID, patients, MAX_PATIENTS,
                           doctors, MAX_DOCTORS);
          break;
        case 2: {
          clear_terminal();
        ...
        case 3: {
          ...
          deletePatientFromWard(wards, &lastAssignedWardID, patients,
                                MAX_PATIENTS);
          break;
        }
        case 4: {
...
void displayPatient(const patientInfo *patient) {
  ...
  printf("          %s║ Blood Type: %-52s║%s\n", CYAN, patient->bloodType,
         RESET);
  printf("          %s║ Contact Number: %-48s║%s\n", CYAN,
         patient->patientContact, RESET);
  printf("          %s║ Address: %-53s  ║%s\n", CYAN, patient->patientAddress,
         RESET);
  printf("          %s║ Emergency Contact: %-43s  ║%s\n", CYAN,
         patient->emergencyContact, RESET);
  printf("          %s║ Username: %-49s     ║%s\n", CYAN,
         patient->patientUserName, RESET);
  printf("          %s║ Password: %-49s     ║%s\n", CYAN, patient->patientPass,
         RESET);
...
void displayDoctor(const doctorInfo *doctor) {
  ...
  printf("          %s║ Address: %-53s  ║%s\n", GREEN, doctor->doctorAddress,
         RESET);
  printf("          %s║ Specialty: %-51s  ║%s\n", GREEN, doctor->specialty,
         RESET);
  printf("          %s║ Experience: %-50d  ║%s\n", GREEN, doctor->experience,
         RESET);
  printf("          %s║ Contact Number: %-46s  ║%s\n", GREEN,
         doctor->doctorContact, RESET);
  printf("          %s║ Username: %-49s     ║%s\n", GREEN,
         doctor->doctorUserName, RESET);
  printf("          %s║ Password: %-49s     ║%s\n", GREEN, doctor->doctorPass,
         RESET);
...
void displayPatientMenu() {
  ...
  printf("                    %s╠════════════════════════════════════════╣%s\n",
         YELLOW, RESET);
  printf("                    %s║ %s1.%s Add patients                        "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s2.%s Search patient                      "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s3.%s Delete patient                      "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s4.%s Display patient information         "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s5.%s Patient login                       "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s6.%s Back to main menu                   "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s╚════════════════════════════════════════╝%s\n",
         YELLOW, RESET);
...
void displayDoctorMenu() {
  ...
  printf("                    %s╠════════════════════════════════════════╣%s\n",
         MAGENTA, RESET);
  printf("                    %s║ %s1.%s Add doctors                         "
         "║%s\n",
         MAGENTA, BLUE, MAGENTA, RESET);
  printf("                    %s║ %s2.%s Search doctor                       "
         "║%s\n",
         MAGENTA, BLUE, MAGENTA, RESET);
  printf("                    %s║ %s3.%s Delete doctor                       "
         "║%s\n",
         MAGENTA, BLUE, MAGENTA, RESET);
  printf("                    %s║ %s4.%s Display doctor schedule             "
         "║%s\n",
         MAGENTA, BLUE, MAGENTA, RESET);
  printf("                    %s║ %s5.%s Doctor login                        "
         "║%s\n",
         MAGENTA, BLUE, MAGENTA, RESET);
  printf("                    %s║ %s6.%s Back to main menu                   "
         "║%s\n",
...
void displayMainMenu() {
  ...
  printf("                    %s╠════════════════════════════════════════╣%s\n",
         BLUE, RESET);
  printf("                    %s║ %s1.%s Patient Panel                       "
         "║%s\n",
         BLUE, GREEN, BLUE, RESET);
  printf("                    %s║ %s2.%s Doctor Panel                        "
         "║%s\n",
         BLUE, GREEN, BLUE, RESET);
  printf("                    %s║ %s3.%s Medical Ward Panel                  "
         "║%s\n",
         BLUE, GREEN, BLUE, RESET);
  printf("                    %s║ %s4.%s Exit                                "
         "║%s\n",
...
void displayWardMenu() {
  ...
  printf("                    %s╠════════════════════════════════════════╣%s\n",
         YELLOW, RESET);
  printf("                    %s║ %s1.%s Add ward                            "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s2.%s Search ward                         "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s3.%s Delete ward                         "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s4.%s Display ward information            "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s5.%s Back to main menu                   "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s╚════════════════════════════════════════╝%s\n",
         YELLOW, RESET);
...
void loadDoctorsFromFile(doctorInfo doctors[MAX_DOCTORS],
                         const char *filename) {
  FILE *file = fopen(filename, "rb");
  if (file == NULL) {
    perror("Error opening file for reading");
...
void displayCalendar(const doctorInfo *doctors) {
  const char *daysOfWeek[] = {"Monday", "Tuesday",  "Wednesday", "Thursday",
  ...
  for (int i = 0; i < DAYS_IN_WEEK; i++) {
    ...
    for (int j = 0; j < SLOTS_PER_DAY; j++) {
      ...
      printf("%-12s (%d appointments)",
             doctors->calendar[i][j] ? "[Available]" : "[Unavailable]", count);
    }
    printf("\n");
  }
}
...
void updateCalendar(doctorInfo *doctors) {
  int day, slot;
  printf("Enter the day you want to update (0 for Monday, 1 for Tuesday, ..., "
         "6 for Sunday): ");
  day = inputInt();
...
void takeAppointment(doctorInfo *doctors, patientInfo *patients) {
  int day, slot;
  printf("Enter the day you want to take appointment (0 for Monday, 1 for "
  ...
  printf("No more appointments available for this slot. Please choose another "
         "slot.\n");
}
...
int docLogIn(const doctorInfo *doctors, int maxCount, const char *inputUser,
  ...
  for (int i = 0; i < maxCount; i++) {
    if (doctors[i].id != -1 &&
        strcmp(doctors[i].doctorUserName, inputUser) == 0 &&
        strcmp(doctors[i].doctorPass, pass) == 0) {
      return i;
    }
  }
  return -1;
...
int patientLogIn(const patientInfo *patients, int maxCount,
  ...
  for (int i = 0; i < maxCount; i++) {
    if (patients[i].id != -1 &&
        strcmp(patients[i].patientUserName, inputUser) == 0 &&
        strcmp(patients[i].patientPass, pass) == 0) {
      return i;
    }
  }
  return -1;
...
void displayPatientSubMenu() {
  ...
  printf("                    %s╠════════════════════════════════════════╣%s\n",
         YELLOW, RESET);
  printf("                    %s║ %s1.%s Check patient info                  "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s2.%s Edit patient info                   "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s3.%s Take doctor's appointment           "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s4.%s Back to patient menu                "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s╚════════════════════════════════════════╝%s\n",
         YELLOW, RESET);
...
void displayDoctorSubMenu() {
  ...
  printf("                    %s╠════════════════════════════════════════╣%s\n",
         YELLOW, RESET);
  printf("                    %s║ %s1.%s Update schedule                     "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s2.%s Edit information                    "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s3.%s Prescribe patient                   "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s║ %s4.%s Back to doctor menu                 "
         "║%s\n",
         YELLOW, BLUE, YELLOW, RESET);
  printf("                    %s╚════════════════════════════════════════╝%s\n",
         YELLOW, RESET);
...
void deleteAll(patientInfo patients[MAX_PATIENTS],
  ...
  *lastAssignedDoctorID = 0;
  ...
  printf("          %s║                      Congratulations!!!                "
         "         ║%s\n",
         RED, RESET);
  printf("          %s║                  You just NUKED the system!!!          "
         "         ║%s\n",
         RED, RESET);
  printf("          %s║                                                        "
         "         ║%s\n",
...
int searchWard(const medicalWard *wards, int maxCount,
               const char *patientName) {
  for (int i = 0; i < maxCount; i++) {
